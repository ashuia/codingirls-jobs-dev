...
function searchPo() {
    ...
    $("#list").empty();
    $.ajax({
        url:`${baseHost}/post/list?keyword=${searchStr}`,
        type:'get',
        success: function (data) {
            render(data);
        }
...
function  getTag() {
    ...
    $("#list").empty();
    $.ajax({
        url:`${baseHost}/post/list?jobtype=${id}`,
        type:'get',
        success: function (data) {
            render(data);
        }
...
function getCatagory() {
    ...
    $("#list").empty();
    $.ajax({
        url:`${baseHost}/post/list?catagory=${id}`,
        type:'get',
        success: function (data) {
            render(data);
        }
...
function getPage() {
    ...
    //alert(id);
    $.ajax({
        url:`${baseHost}/post/list?page=${id}`,
        type:'get',
        success: function (data) {
            render(data);
        }
